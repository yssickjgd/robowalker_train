...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = BoardA_DBUS_Rx_Pin|BoardA_DBUS_Idle_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PD5     ------> USART2_TX
    */
    GPIO_InitStruct.Pin = BoardA_Bluetooth_Rx_Pin|BoardA_Bluetooth_Tx_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PD8     ------> USART3_TX
    */
    GPIO_InitStruct.Pin = BoardA_USART3_Rx_Pin|BoardA_USART3_Tx_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE7     ------> UART7_RX
    */
    HAL_GPIO_DeInit(GPIOE, BoardA_UART7_Tx_Pin|BoardA_UART7_Rx_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, BoardA_DBUS_Rx_Pin|BoardA_DBUS_Idle_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD5     ------> USART2_TX
    */
    HAL_GPIO_DeInit(GPIOD, BoardA_Bluetooth_Rx_Pin|BoardA_Bluetooth_Tx_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD8     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOD, BoardA_USART3_Rx_Pin|BoardA_USART3_Tx_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PG9     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOG, BoardA_USART6_Tx_Pin|BoardA_USART6_Rx_Pin);
