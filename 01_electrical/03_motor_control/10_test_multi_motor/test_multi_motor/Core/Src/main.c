...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    motor_6020.PID_Omega.Init(500.0f, 2000.0f, 0.0f, 0.0f, 25000.0f, 25000.0f);
  ...
  /* USER CODE BEGIN WHILE */
    ...
    {
        Counter++;
        motor_3508.Set_Target_Omega(10 * sin((float)Counter / 1000.0f * 3.0f));
        motor_6020.Set_Target_Angle((Counter / 2000) % 2 == 0 ? 0.0f : PI);

        //串口绘图显示内容
        
        Target_Omega_3508 = motor_3508.Get_Target_Omega();
        Now_Omega_3508 = motor_3508.Get_Now_Omega();
        Target_Angle_6020 = motor_6020.Get_Target_Angle();
        Now_Angle_6020 = motor_6020.Get_Now_Angle();
        Target_Omega_6020 = motor_6020.Get_Target_Omega();
        Now_Omega_6020 = motor_6020.Get_Now_Omega();
        Target_Current_6020 = motor_6020.Get_Target_Torque();
        Now_Current_6020 = motor_6020.Get_Now_Torque();
        serialplot.Set_Data(8, &Target_Omega_3508, &Now_Omega_3508, &Target_Angle_6020, &Now_Angle_6020, &Target_Omega_6020, &Now_Omega_6020, &Target_Current_6020, &Now_Current_6020);
